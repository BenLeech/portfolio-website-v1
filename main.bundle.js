...
var AppComponent = (function () {
    function AppComponent(router, location, renderer) {
        this.router = router;
    ...
    AppComponent.prototype.disableHover = function () {
        if (!this.hasHoverClass)
            return;
...
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["o" /* HostListener */])('mousemove'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", void 0)
], AppComponent.prototype, "enableHover", null);
__decorate([
...
AppComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__angular_router__["c" /* Router */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_router__["c" /* Router */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_2__angular_common__["b" /* Location */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__angular_common__["b" /* Location */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_0__angular_core__["l" /* Renderer2 */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_0__angular_core__["l" /* Renderer2 */]) === "function" && _c || Object])
], AppComponent);
...
// module
exports.push([module.i, ".footer {\n  padding: 35px 15px 15px 15px;\n  display: -ms-flexbox;\n  display: flex;\n  -ms-flex-align: center;\n      align-items: center;\n  -ms-flex-direction: column;\n      flex-direction: column;\n  position: relative;\n  background-color: #494E6B;\n  color: #fff; }\n\n.social-media-container {\n  font-size: 20px;\n  color: #494E6B;\n  margin-bottom: 20px; }\n\n.social-media-container * {\n  transition: all 0.3s ease; }\n\n.fa-circle {\n  color: #192231; }\n\n.copyright-info {\n  font-size: 12px;\n  color: #ebebeb; }\n\n:host-context(body.hasHover) .linkedin:hover .fa-circle {\n  color: #24559c; }\n\n:host-context(body.hasHover) .linkedin:hover .fa-linkedin-square {\n  color: #ebebeb; }\n\n:host-context(body.hasHover) .github:hover .fa-circle {\n  color: #000; }\n\n:host-context(body.hasHover) .github:hover .fa-github {\n  color: #ebebeb; }\n\n:host-context(body.hasHover) .instagram:hover .fa-circle {\n  color: #bd286d; }\n\n:host-context(body.hasHover) .instagram:hover .fa-instagram {\n  color: #ebebeb; }\n\n.btn-back-to-top {\n  position: absolute;\n  top: 10%;\n  right: 30px;\n  font-size: 26px;\n  color: #192231; }\n\n.btn-back-to-top .fa-circle {\n  color: #494E6B; }\n\n.btn-back-to-top * {\n  transition: all 0.3s ease; }\n\n:host-context(body.hasHover) .btn-back-to-top:hover span {\n  transform: translateY(-5px); }\n\n:host-context(body.hasHover) .btn-back-to-top:hover .fa-circle {\n  color: #ebebeb; }\n", ""]);
...
// module
exports.push([module.i, ".navbar-wrapper {\n  position: fixed;\n  top: 0;\n  width: 100%;\n  z-index: 10;\n  font-size: 15px;\n  transition: all 1s ease; }\n\n.bg-transparent {\n  background-color: transparent !important; }\n\n.personal-logo {\n  height: 30px;\n  margin-right: 10px; }\n\n.navbar {\n  color: #fff;\n  padding: 0 45px 0 45px;\n  height: 50px;\n  display: -ms-flexbox;\n  display: flex;\n  -ms-flex-pack: justify;\n      justify-content: space-between;\n  -ms-flex-align: center;\n      align-items: center; }\n\n.nav-links-container {\n  height: 100%;\n  display: -ms-flexbox;\n  display: flex;\n  -ms-flex-align: center;\n      align-items: center; }\n\n.nav-links-container .fa-times {\n  font-size: 28px;\n  margin-top: 15px; }\n\n.logo-container {\n  padding-left: 10px;\n  padding-right: 10px;\n  height: 100%;\n  display: -ms-flexbox;\n  display: flex;\n  -ms-flex-align: center;\n      align-items: center; }\n\n.nav-link {\n  padding: 0 20px 0 20px;\n  height: 100%;\n  display: -ms-flexbox;\n  display: flex;\n  -ms-flex-align: center;\n      align-items: center;\n  transition: color 0.1s ease; }\n\n:host-context(body.hasHover) .nav-link:hover {\n  color: #e1d3cf; }\n\n:host-context(body.hasHover) .logo-container:hover {\n  color: #e1d3cf; }\n\n.dropdown-container {\n  width: 100%;\n  height: 100%;\n  background-color: rgba(25, 34, 49, 0.95);\n  display: -ms-flexbox;\n  display: flex;\n  -ms-flex-direction: column;\n      flex-direction: column;\n  -ms-flex-pack: center;\n      justify-content: center;\n  position: fixed;\n  top: 0;\n  z-index: 9;\n  transition: all 1s ease; }\n\n.dropdown-inner {\n  color: #cecece;\n  width: 100%;\n  display: -ms-flexbox;\n  display: flex;\n  -ms-flex-direction: column;\n      flex-direction: column;\n  -ms-flex-align: center;\n      align-items: center;\n  -ms-flex-pack: center;\n      justify-content: center;\n  font-size: 28px; }\n\n.dropdown-end {\n  width: 100%;\n  height: 50px; }\n\n.dropdown-container-down {\n  max-height: 1000px;\n  transition: all 0.05s linear; }\n\n.dropdown-container-up {\n  max-height: 0;\n  overflow: hidden;\n  transition: all 0.05s ease-out; }\n\n.nav-dropdown-link-row:before {\n  content: \"\";\n  position: absolute;\n  bottom: calc(50% - 5px);\n  left: 50%;\n  right: 50%;\n  background-color: #985E6D;\n  height: 10px;\n  z-index: -1;\n  transition: all 0.25s ease; }\n\n.nav-dropdown-link-row {\n  padding: 15px;\n  position: relative;\n  overflow: hidden;\n  display: inline-block;\n  transform: perspective(1px) translateZ(0); }\n\n:host-context(body.hasHover) .nav-dropdown-link-row:hover {\n  color: #fff; }\n\n:host-context(body.hasHover) .nav-dropdown-link-row:hover:before {\n  left: 0;\n  right: 0; }\n\n.navbar .fa-bars {\n  display: none; }\n\n:host-context(body.hasHover) .sticky-nav .logo-container:hover {\n  color: #ebebeb;\n  background-color: #3c415a; }\n\n:host-context(body.hasHover) .sticky-nav .nav-link:hover {\n  color: #ebebeb;\n  background-color: #3c415a; }\n\n.active {\n  background-color: #3c415a; }\n\n.social-media-container {\n  color: #cecece;\n  display: -ms-flexbox;\n  display: flex;\n  -ms-flex-pack: center;\n      justify-content: center;\n  position: absolute;\n  bottom: 50px;\n  text-align: center;\n  width: 100%; }\n\n:host-context(body.hasHover).social-media-container span:hover .fa-circle {\n  color: #985E6D; }\n\n.social-media-container .fa-circle {\n  color: #494E6B; }\n\n@media (max-width: 780px) {\n  .navbar {\n    background-color: #192231;\n    padding: 0 20px 0 20px; }\n  .nav-link {\n    display: none; }\n  .navbar .fa-bars {\n    display: block;\n    font-size: 1.3rem; } }\n\n@media (min-width: 781px) {\n  .dropdown-container {\n    display: none; }\n  .nav-links-container .fa-times {\n    display: none; } }\n", ""]);
    ...
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_11" /* Component */])({
        ...
        animations: [
            __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__angular_animations__["i" /* trigger */])('dropdownMenuState', [
                ...
                __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__angular_animations__["j" /* state */])('mobileMenu', __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__angular_animations__["h" /* style */])({
                    'height': '100%'
                })),
